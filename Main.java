...
public class Main extends JFrame {
	...
	/**
	 * This constructor is used to initialize the menu bar (with it's options) and the object of
	 * Workspace, where cities will be created and dragged. It also creates the instance of class 
	 * TSPNN and adds the object of class Workspace as a observer in class TSPNN.
	 */
	public Main() {
        ...
        JMenuItem cluster = new JMenuItem("K-Means Clustering Algorithm");
        ...
        userConnect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				...
				messageDisplayer.setMessageColor(Color.CYAN);
				messageDisplayer.setMessage(
						"Existing connections are removed and you can create new connections.");
	    	}
		});
	...
	private boolean clusterClicked(KMeans kMeans) {
		...
		do {
			clusterStr = JOptionPane.showInputDialog(this, 
					"Please enter the number of clusters you want : ", null);
		...
		do {
			clusterStr = JOptionPane.showInputDialog(this, 
					"Please enter the number of iterations : ", null);
			isItRight = isNumeric(clusterStr);
			if(isItRight) {
